...
const About = () => {
  ...
  const initialImageOrder = [
    { src: "/crownfix.jpeg", alt: "Dental Crowns" },
    {
      ...
      alt: "Tooth Whitening (Cosmetic Dentistry)",
    },
      ...
      >
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-[4rem] px-4 items-center">
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
            <h2 className="text-2xl md:text-3xl lg:text-4xl mb-2">About Us</h2>
              ...
              >
                <motion.div layout className="flex flex-col items-center">
                  <img
                    src={member.image}
                    alt={member.name}
                    className="w-32 h-32 sm:w-40 sm:h-40 md:w-48 md:h-48 object-cover object-center rounded-full mb-4"
                  />
